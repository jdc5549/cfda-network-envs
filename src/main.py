...
if __name__ == '__main__':
    ...
    if args.net_type == 'File':
        ...
        env = NetworkCascEnv(args.net_size,args.p,args.p,'File',discrete_obs=args.discrete_obs,degree=args.degree,topo_eps=topo_eps,cascade_type=args.cascade_type,
        ...
        env = NetworkCascEnv(args.net_size,args.p,args.p,args.net_type,degree=args.degree,discrete_obs=args.discrete_obs,topo_eps=topo_eps,cascade_type=args.cascade_type,filename=args.net_file_train_dir)
    ...
    if args.train: 
        hparams = {"training_steps": args.training_steps, "learning_rate": args.learning_rate, "sched_step": args.sched_step, "sched_gamma":args.sched_gamma,
            ...
            "mlp_hidden_size": args.mlp_hidden_size, "net_type": args.net_type, "net_size": args.net_size, "p": args.p, "degree": args.degree}
        ...
        test_envs = [NetworkCascEnv(args.net_size,args.p,args.p,'File',discrete_obs=args.discrete_obs,degree=args.degree,cascade_type=args.cascade_type,
        ...
        #tic = time.perf_counter()
        mas.learn(env,nb_timesteps=args.training_steps,test_freq=args.test_freq,save_freq=args.save_freq,multi_proc=False,verbose=2,test_envs=test_envs)#,exploiters=args.exploiters)
        toc = time.perf_counter()
