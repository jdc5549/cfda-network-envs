...
class NetworkCascEnv(gym.Env):
    def __init__(self,net_size,p_atk,p_def,net_type,embed_size=1,degree=2,cascade_type='threshold',filename=None,discrete_obs=False,topo_eps=None):
        ...
        self.num_nodes_attacked = int(math.floor(p_atk * self.net_size))
        #print("Attacking {} of {} Nodes".format(self.num_nodes_attacked,self.net_b.number_of_nodes()))
        self.num_nodes_defended = int(math.floor(p_def * self.net_size))
